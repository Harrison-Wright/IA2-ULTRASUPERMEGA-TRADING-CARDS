...
import game_window
from main_window import Ui_Main_menuWindow
...
class MainWindow:
    ...
    def __init__(self, difficulty, pack_size):
        ...
        self.ui = game_window.Ui_MainWindow()
    ...
    def establish_poss_cards(self):
        ...
        print(max_cards)
        all_cards = list(range(1, int(max_cards) + 1))
    ...
    def display_ai_card(self,card):
        ...
        if self.reveal:
            ...
            self.ui.ai_int_lb.setText(str(card.intel))
